      ...
      if (imageAttachments.length > 0) {
        for (let i = 0; i < imageAttachments.length; i++) {
          ...
          try {
             ...
             const file = new File([blob], `image-${i+1}.${ext}`, { type: blob.type || 'image/jpeg' });
      ...
      <div className="profile-section__toggle-header">
        ...
        <div className="relative shrink-0">
          <button
            ...
            disabled={isSharing}
            className="flex items-center gap-1.5 rounded-lg bg-green-50 px-2.5 py-1 text-xs font-bold text-green-700 hover:bg-green-100 border border-green-200 transition-colors disabled:opacity-50"
            title="مشاركة الصور كملفات"
          >
